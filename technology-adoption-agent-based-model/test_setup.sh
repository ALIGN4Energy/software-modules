...
echo "  python run_abm.py --household_data tutorial_households.csv --tech_config tutorial_technologies.csv"
echo "  python run_abm.py --household_data tutorial_households.csv --tech_config tutorial_technologies.csv --n_runs 50 --years 15"
echo "  python run_abm.py --help"
echo ""
echo "Option 2: Run with Docker (recommended)"
echo "  1. Start Docker Desktop"
echo "  2. docker build -t technology-adoption-abm ."
echo "  3. docker run --rm -v \$(pwd):/app technology-adoption-abm \\"
echo "       --household_data tutorial_households.csv --tech_config tutorial_technologies.csv"
echo ""
echo "Usage examples:"
...
echo "  docker run --rm -v \$(pwd):/app technology-adoption-abm \\"
echo "    --household_data tutorial_households.csv --tech_config tutorial_technologies.csv \\"
echo "    --peer_effect 0.5"
echo ""
echo "  # Get help"
echo "  docker run --rm technology-adoption-abm help"
